...
DEFAULT_ATTR_PATH = os.environ.get("WEBSHOP_ATTR_PATH", join(BASE_DIR, '../data/items_ins_v2_1000.json'))
DEFAULT_FILE_PATH = os.environ.get("WEBSHOP_FILE_PATH", join(BASE_DIR, '../data/items_shuffle_1000.json'))
...
HUMAN_ATTR_PATH = os.environ.get("WEBSHOP_HUMAN_ATTR_PATH", join(BASE_DIR, '../data/items_human_ins.json'))
